...
export class AuthController {
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Register successfully.', type: CreateUserDto })
  @ApiResponse({ status: HttpStatus.INTERNAL_SERVER_ERROR, description: 'Internal server error.' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Invalid input' })
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Send mail successfully.' })
  @ApiResponse({ status: HttpStatus.INTERNAL_SERVER_ERROR, description: 'Internal server error.' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Invalid input' })
  ...
  @ApiResponse({ status: HttpStatus.INTERNAL_SERVER_ERROR, description: 'Internal server error.' })
  verifyResetPassword(@Query('token') token: string, @Body() resetPasswordDto: ResetPasswordDto) {
